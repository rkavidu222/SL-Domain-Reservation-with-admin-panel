...
<div class="admin-management-container">
    ...
    {{-- Search Form --}}
    <form method="GET" action="{{ route('admin.users.index') }}" class="mb-3 d-flex justify-content-end">
        <input
            type="text"
            name="search"
        ...
        @if(request('search'))
            <a href="{{ route('admin.users.index') }}" class="btn btn-secondary ms-2">Clear</a>
        @endif
    </form>
